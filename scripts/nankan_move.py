...
── 展開で割ると（ユーザーの立場「下げないのに人気がない馬は展開がハマれば来る」）

  **前半は支持された。**人気薄(7番人気以下)の3着内率は展開で 1.8倍動く:

      前が楽な流れ              n=134   6.0%
      前が止まった流れ           n=146   9.6%
      前が大きく止まった(+0.30〜) n= 84  **10.7%**

  ⚠️⚠️ **後半（どの人気薄か）は決まらない。線の引き方で答えが逆になる。**

      人気薄 × 前が大きく止まった の中で「下げない馬」
        絶対値で切る(平均≤-0.05)  n=11  3着内 **0頭**  複勝回収   0.0%
        相対で切る(上位1/3)       n=23  3着内 **4頭**  複勝回収 267.4%
                                            （最高配当を1つ抜くと 79.1%）

     **n が小さすぎて決まらない**という意味であって、効くという意味ではない。
     この開催のサブグループの複勝回収は、**ほぼ全部1頭で作られている**。
     100%超えを見たら必ず「最高配当抜き」を見ること。

  ⚠️ 展開の事前予測は弱い。先行型の頭数比は 止 0.296 / 楽 0.251（50鞍）。
     方向は合うが、これで展開を当てられるとは言えない。
"""
